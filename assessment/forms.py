...
class ApplicationForm(forms.ModelForm):
	...
	class Meta:
		model = Application
		fields = ['name', 'purpose', 'application_type', 'website', 'cost', 'cost_type', 'requestor', 'business_owner', 'businessunit']
		widgets = {			
			...
			'businessunit': Select2MultipleWidget(attrs={'class' : 'w3-input w3-border', }),
...
class ICTRiskAssessmentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'bu_record_volume': forms.RadioSelect(attrs={'class': 'w3-ul'}),
            'bu_downtime_before_critical': forms.RadioSelect(attrs={'class': 'w3-ul'}),
            'bu_log_data_changes': forms.RadioSelect(attrs={'class': 'w3-ul'}),
            'bu_small_data_loss': forms.RadioSelect(attrs={'class': 'w3-ul'}),
            'bu_large_data_loss': forms.RadioSelect(attrs={'class': 'w3-ul'}),
            'bu_breach_plan': forms.RadioSelect(attrs={'class': 'w3-ul'}),
            'bu_disrupt_plan': forms.RadioSelect(attrs={'class': 'w3-ul'}),
            'bu_perm_loss': forms.RadioSelect(attrs={'class': 'w3-ul'}),
        }
